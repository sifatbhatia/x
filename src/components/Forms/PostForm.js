...
const EditPostForm = () => {
  const {feedbackData, setFeedbackData, closePostForm, editPostId, edited, setEdited} = useContext(PostContext);
  ...
  const editPost = (e) => {
    ...
    setFeedbackData(
      cloneDeep(feedbackData.map(data=>{
